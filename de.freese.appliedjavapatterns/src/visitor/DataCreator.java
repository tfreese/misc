...
public class DataCreator
{
	...
	{
		Contact contact =
				new ContactImpl("Test", "Subject", "Volunteer", "United Patterns Consortium");
		...
		project.addProjectItem(new Deliverable("Deliverable 1", "Layer 1 deliverable", contact,
				50.0, 50.0));
		...
		dtask2.addProjectItem(new Deliverable("Deliverable 2", "Layer 3 deliverable", contact,
				50.0, 50.0));

		task3.addProjectItem(new Deliverable("Deliverable 3", "Layer 3 deliverable", contact, 50.0,
				50.0));
		task4.addProjectItem(new Task("Task 7", contact, 1));
		task4.addProjectItem(new Deliverable("Deliverable 4", "Layer 3 deliverable", contact, 50.0,
				50.0));
