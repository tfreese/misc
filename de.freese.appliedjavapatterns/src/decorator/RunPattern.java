...
public class RunPattern
{
	...
	public static void main(final String[] arguments)
	{
		...
		System.out.println();
		System.out
				.println("Note that the toString method has been overridden for all ProjectItems,");
		...
		Contact contact1 =
				new ContactImpl("Simone", "Roberto", "Head Researcher and Chief Archivist",
