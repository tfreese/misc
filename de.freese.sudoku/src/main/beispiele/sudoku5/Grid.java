...
public class Grid
{
	...
	/**
	 * Available numbers in each box, row and column, used for contructing a valid grid (in function
	 * 'create')
	 */
	 ...
	 * @return boolean
	 */
	public boolean create(final int[][] grid, final boolean[][] boxes, final boolean[][] rows,
							final boolean[][] cols, final int level)
	{
		boolean validFound;
	...
	public void createSudoku()
	{
		...
		if (this.output)
		{
			...
			System.out.println("Puzzle created in " + (t2 - t) + " ms,\n" + "with "
					+ this.difficulty + " difficulty points\n" + "and " + this.countGiven
					+ " given numbers.");
		}
	}
	...
	/**
	 * randomGiven(x) means: exactly x numbers are shown. The lower this number, the more difficult
	 * the puzzle. At least 17 numbers need to be shown for any puzzle to be solvable.
	 * 
