...
class Solver
{
	...
	/**
	 * Returns the number of known values in the grid (usefull for checking wether the grid has
	 * changed after an operation).
	 * 
	 * @return int
	 */
	...
	/**
	 * When a certain value K is derived for a square (i,j), pass it to this function and grid and V
	 * will both be updated to the new situation.
	 * 
	 * @param i int
	 * @param j int
	 * @param K int
