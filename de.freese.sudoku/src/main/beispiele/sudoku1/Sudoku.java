 ...
 * href="http://en.wikipedia.org/wiki/Eight_queens_puzzle">eight queens algorithm</a>.
 * 
 * @version 1.0
...
public class Sudoku
{
	...
	/**
	 * Print the specified Sudoku problem and its solution. The problem is encoded as specified in
