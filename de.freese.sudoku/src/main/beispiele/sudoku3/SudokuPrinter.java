...
public class SudokuPrinter
{
	...
	/**
	 * Die Seitenlänge (Grösse) des Sudokus. Die Seitenlänge des Sudokus bestimmt auch die Anzahl
	 ...
	 * @param blockCol int
	 */
	private static void writeBlockHtml(final StringBuffer strBuff, final int blockRow,
										final int blockCol)
	{
