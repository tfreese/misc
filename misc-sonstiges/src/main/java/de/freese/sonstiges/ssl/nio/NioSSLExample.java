package de.freese.sonstiges.ssl.nio;
...
public class NioSSLExample
{
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        {
            /**
             * @see de.freese.sonstiges.ssl.nio.SSLProvider#onClosed()
             */
            @Override
            ...
            /**
             * @see de.freese.sonstiges.ssl.nio.SSLProvider#onFailure(java.lang.Exception)
             */
            @Override
            ...
            /**
             * @see de.freese.sonstiges.ssl.nio.SSLProvider#onInput(java.nio.ByteBuffer)
             */
            @Override
            ...
            /**
             * @see de.freese.sonstiges.ssl.nio.SSLProvider#onSuccess()
             */
            @Override
