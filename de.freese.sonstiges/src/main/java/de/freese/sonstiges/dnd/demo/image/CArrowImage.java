...
/**
 * A BufferedImage of one of four types of arrow (up, down, left or right) drawn to the size
	...
	public CArrowImage(final int nWidth, final int nHeight, final int nArrowDirection)
	{
		...
		switch (nArrowDirection)
		{
			case ARROW_UP:
				...
				g2.setPaint(new GradientPaint(w13, h13, SystemColor.controlLtHighlight, w, h - 1,
			...
			case ARROW_DOWN:
				...
				this._pathArrow.closePath();
				g2.setPaint(new GradientPaint(0, 0, SystemColor.controlLtHighlight, w23, h23,
						SystemColor.controlShadow));
				g2.fill(this._pathArrow);
