...
class Picture extends JComponent implements MouseListener, FocusListener, Accessible
{
	...
	protected void paintComponent(final Graphics graphics)
	{
		...
		g.fillRect(0, 0, (this.image == null) ? 125 : this.image.getWidth(this),
				(this.image == null) ? 125 : this.image.getHeight(this));
		...
		g.drawRect(0, 0, (this.image == null) ? 125 : this.image.getWidth(this),
				(this.image == null) ? 125 : this.image.getHeight(this));
		g.dispose();
	}
}
