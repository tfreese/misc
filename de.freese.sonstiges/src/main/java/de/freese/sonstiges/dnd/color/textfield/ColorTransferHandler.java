...
/*
 * ColorTransferHandler.java is used by the 1.4 DragColorDemo.java and DragColorTextFieldDemo
 * examples.
 */
...
/**
 * An implementation of TransferHandler that adds support for dropping colors. Dropping a dnd.color
 * on a component having this TransferHandler changes the foreground or the background of the
 * component to the dropped dnd.color, according to the value of the changesForegroundColor
 * property.
 */
