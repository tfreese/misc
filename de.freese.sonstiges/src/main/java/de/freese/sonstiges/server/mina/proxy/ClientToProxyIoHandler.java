...
public class ClientToProxyIoHandler extends AbstractProxyIoHandler
{
	...
	/**
	 * Erstellt ein neues {@link ClientToProxyIoHandler} Object.
	 * 
	 * @param connector {@link IoConnector}
	 * @param remoteAddress {@link SocketAddress}
	 */
	public ClientToProxyIoHandler(final IoConnector connector, final SocketAddress remoteAddress)
	{
		super();
	...
	{
		this.connector.connect(this.remoteAddress).addListener(
				new IoFutureListener<ConnectFuture>()
				{
					/**
					 * @see IoFutureListener#operationComplete
					 */
					@Override
