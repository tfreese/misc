 ...
 * {@link SSLEngine#setNeedClientAuth(boolean)} before creating {@link SslHandler}.</li>
 * <li>When initializing an {@link SSLContext} on the client side, specify the {@link KeyManager}
 * that contains the client certificate as the first argument of
 * {@link SSLContext#init(KeyManager[], TrustManager[], SecureRandom)}.</li>
 * <li>When initializing an {@link SSLContext} on the server side, specify the proper
 * {@link TrustManager} as the second argument of
