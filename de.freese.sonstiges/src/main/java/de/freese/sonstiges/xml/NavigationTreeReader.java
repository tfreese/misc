		...
		while (reader.hasNext())
		{
			...
			switch (type)
			{
				case XMLStreamConstants.START_ELEMENT:
					...
					{
						System.out
								.printf("%d: AttributeLocalName=%s, AttributeValue=%s, AttributePrefix=%s\n",
										Integer.valueOf(i), reader.getAttributeLocalName(i),
										reader.getAttributeValue(i), reader.getAttributePrefix(i));
					}
				...
				case XMLStreamConstants.CHARACTERS:
					System.out.println("CHARACTERS="
							+ (reader.isWhiteSpace() ? "" : reader.getText()));
					break;
