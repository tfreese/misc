...
public class ExtendedNode extends Node {
    ...
    public ExtendedNode(final long aId,
                   ...
                   final double aLongitude, Collection<Tag> aTags) {
        super(aId, aVersion, new Date(), null, aTags, aLatitude, aLongitude);
    }
    ...
    public ExtendedNode(final long aId,
        ...
        super(aId, aVersion, new Date(), null, new LinkedList<Tag>(), aLatitude, aLongitude);
    }
