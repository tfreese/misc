...
public class WayPlace extends Place implements IWayPlace {
    ...
    /**
     * @param aWay The way to return.
     * @param aMap my map
     */
    public WayPlace(final Way aWay, final IDataSet aMap) {
        super(WayHelper.getTag(aWay, Tags.TAG_NAME),
                aMap.getNodeByID(aWay.getWayNodes().get(0).getNodeId()).getLatitude(),
                aMap.getNodeByID(aWay.getWayNodes().get(0).getNodeId()).getLongitude());
