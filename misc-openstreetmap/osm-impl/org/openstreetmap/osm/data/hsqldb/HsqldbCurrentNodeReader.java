...
public class HsqldbCurrentNodeReader  extends HsqldbBaseReader<Node> {
    ...
    public Node getNext() {
        ...
        List<org.openstreetmap.osmosis.core.domain.v0_5.Tag> v5tags = tagParser.parseTags(tags);
        Collection<Tag> v6tags = new ArrayList<Tag>(v5tags.size());
        for (org.openstreetmap.osmosis.core.domain.v0_5.Tag tag : v5tags) {
            v6tags.add(new Tag(tag.getKey(), tag.getValue()));
        }
        node = new Node(id, version, timestamp, (OsmUser) null, v6tags, latitude, longitude);
