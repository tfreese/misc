 ...
 * Da die Tiefen-/Höheninformation für zweidimensionale Darstellungen irrelevant ist wird diese
 * neutralisiert.
 * 
...
{
	/**
	 * Liefert den Faktor, der benötigt wird, um das world-Rechteck in das win-Rechteck zu skalieren
	 * (einzupassen) bezogen auf die Breite der X-Achse.
	 * 
	...
	/**
	 * Liefert den Faktor, der benötigt wird, um das world-Rechteck in das win-Rechteck zu skalieren
	 * (einzupassen) bezogen auf die Höhe der Y-Achse.
	 * 
	 * @param world Das Rechteck in Weltkoordinaten
	 * @param win Das Rechteck in Bildschirmkoordinaten
	 * @return Der Skalierungsfaktor
	...
	/**
	 * Liefert eine Matrix, die eine vorhandene Transformationsmatrix erweitert, um an einem
	 * bestimmten Punkt um einen bestimmten Faktor in die Karte hinein- bzw. heraus zu zoomen.
	 * 
	...
	/**
	 * Liefert eine Matrix, die alle notwendigen Transformationen beinhaltet (Translation,
	 * Skalierung, Spiegelung und Translation), um ein world-Rechteck in ein win-Rechteck
	 * abzubilden.
	 * 
	 * @param world Das Rechteck in Weltkoordinaten
	 * @param win Das Rechteck in Bildschirmkoordinaten
	 ...
	 * 
	 */
	private double m21 = 0.0D;

	/**
	 * 
	 */
	private double m22 = 0.0D;

	/**
	 * 
	 */
	private double m23 = 0.0D;

	/**
	 * 
	 */
	private double m31 = 0.0D;

	/**
	 * 
	 */
	private double m32 = 0.0D;

	/**
	 * 
	 */
	private double m33 = 0.0D;
	...
	{
		double myDet =
				((this.m11 * this.m22 * this.m33) + (this.m12 * this.m23 * this.m31) + (this.m13
						* this.m21 * this.m32))
	...
	/**
	 * Liefert eine Matrix, die das Ergebnis einer Matrizenmultiplikation zwischen dieser und der
	 * übergebenen Matrix ist.
	 * 
