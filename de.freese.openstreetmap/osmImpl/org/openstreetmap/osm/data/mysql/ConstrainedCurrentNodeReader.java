...
public class ConstrainedCurrentNodeReader  extends ConstrainedBaseReader<Node> {
    ...
    public Node getNext() {
        ...
        List<org.openstreetmap.osmosis.core.domain.v0_5.Tag> oldTags = tagParser.parseTags(tags);
        ...
        node = new Node(id, version, timestamp, null, newTags, latitude, longitude);
