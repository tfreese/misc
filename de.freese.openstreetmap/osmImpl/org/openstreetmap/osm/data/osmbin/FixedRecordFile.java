...
public abstract class FixedRecordFile {
     ...
     */
    private long memoryMapped_FirstByte = 0;
...
//            }
     ...
     // we duplicate, so that position in the returned records are independend
        ...
        retval.position((int) (pos - memoryMapped_FirstByte));
        return retval;
    }
    /**
...
//        }
    ...
    public long growFile(final long aPreferedCount, final long aMinimumCount) throws IOException {
        ...
        try {
            ...
            this.memoryMapped = null;
            this.memoryMapped_FirstByte = getRecordCount() * getRecordLength();
            this.memoryMapped = this.myFileChannel.map(FileChannel.MapMode.READ_WRITE, this.memoryMapped_FirstByte, aPreferedCount * getRecordLength());
            setRecordCount(getRecordCount() + (long) aPreferedCount);
            return aPreferedCount;
        } catch (IOException x) {
