...
public class NioSocketSession implements IoSession
{
	 ...
	 */
	public NioSocketSession(final IoProcessor<NioSocketSession> processor, final IoHandler handler,
	...
	/**
	 * @see de.freese.littlemina.core.session.IoSession#setAttribute(java.lang.Object,
	 *      java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see de.freese.littlemina.core.session.IoSession#setBuffer(de.freese.littlemina.core.buffer.IoBuffer)
	 */
	@Override
	...
	/**
	 * @see de.freese.littlemina.core.session.IoSession#write(de.freese.littlemina.core.buffer.IoBuffer)
	 */
	@Override
	public void write(final IoBuffer buffer) throws Exception
	{
		setBuffer(buffer);
