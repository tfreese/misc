...
public class Barista
{
	...
	public Drink prepareColdDrink(final OrderItem orderItem)
	{
		try
		{
			...
			this.logger.info(Thread.currentThread().getName() + " prepared cold drink #"
					+ this.coldDrinkCounter.incrementAndGet() + " for order #"
	...
	public Drink prepareHotDrink(final OrderItem orderItem)
	{
		try
		{
			...
			this.logger.info(Thread.currentThread().getName() + " prepared hot drink #"
					+ this.hotDrinkCounter.incrementAndGet() + " for order #"
					+ orderItem.getOrder().getNumber() + ": " + orderItem);
