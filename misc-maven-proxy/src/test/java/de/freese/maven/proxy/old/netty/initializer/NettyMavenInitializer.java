// Created: 27.03.2018
package de.freese.maven.proxy.old.netty.initializer;

import java.nio.charset.Charset;
import java.util.Objects;
import de.freese.maven.proxy.MavenProxy;
import de.freese.maven.proxy.old.netty.codec.NettyMavenProtocolDecoder;
import de.freese.maven.proxy.old.netty.codec.NettyMavenProtocolEncoder;
import de.freese.maven.proxy.old.netty.handler.NettyMavenRequestHandler;
