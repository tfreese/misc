...
/**
 * This is a sample element that extends <code>TickerElement</code> - the abstrat class that
 * represents a ticker's text base element.
 * <p>
...
public class StockTickerElement extends AbstractTickerElement
{
	...
	/**
	 * Creates a <tt>StockTickerElement</tt> with the given name
	 * 
	 * @param stock the stock's name
	 */
	public StockTickerElement(final String stock)
	{
		super(new Token[4]);
	 ...
	 * @see net.ledticker.demo.elements.StockTickerElementUpdater#setLast(double)
	 */
	 ...
	 * @see net.ledticker.demo.elements.StockTickerElementUpdater#setChange(double)
	 */
