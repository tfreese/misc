...
public class DataCreator
{
	...
	private static Serializable createData()
	{
		...
		Task task4 =
				new Task(task1, "Fortune1",
						"Use psychic hotline to predict winning lottery numbers", null, false);
		Task task5 =
				new Task(task1, "Fortune2", "Invest winnings to ensure 50% annual interest",
						contact1, true);
		Task task6 =
				new Task(task2, "Isle1",
						"Research whether climate is better in the Atlantic or Pacific", contact1,
						true);
		...
		Task task10 =
				new Task(task3, "Name2", "Eliminate any choices that are not coffee-related",
						contact4, false);
