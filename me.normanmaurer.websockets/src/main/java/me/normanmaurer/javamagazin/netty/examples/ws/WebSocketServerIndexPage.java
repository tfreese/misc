...
public final class WebSocketServerIndexPage
{
	 ...
	 * 
	 * @param webSocketLocation String
	 * @return html {@link ChannelBuffer}
	 */
	public static ChannelBuffer getContent(final String webSocketLocation)
	{
		StringBuilder page = new StringBuilder();
		page.append("<html><head><title>Web Socket Nachrichten Beispiel</title></head>").append(
				NEWLINE);
		...
		page.append("<textarea id=\"msgs\" style=\"width:500px;height:300px;\"></textarea>")
				.append(NEWLINE);
		page.append("</body>").append(NEWLINE);
	...
	/**
	 * Erstellt ein neues {@link WebSocketServerIndexPage} Object.
	 */
