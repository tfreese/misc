...
{
	/**
	 * Erstellt ein neues {@link AlgorythmRecursiveBacktracking} Object.
	 */
	public AlgorythmRecursiveBacktracking()
	{
		super();
	}
	...
	{
		return !checkBox(grid, x, y, value) && !checkColumn(grid, x, value)
