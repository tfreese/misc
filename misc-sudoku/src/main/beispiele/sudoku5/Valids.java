...
/**
 * A Valids-object is basically a matrix N*N*N of booleans, where V[i,j,k] is true if number k is a valid option for square (i,j), considering the values that
 * are filled in in the puzzle.
 */
public class Valids
{
    /**
