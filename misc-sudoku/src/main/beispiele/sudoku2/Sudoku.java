...
class Sudoku
{
    ...
    public boolean solveBacktrack(int i, int j)
    {
        if (j == this.n)
        { /*
           * Zeilenende erreicht, fange wieder links an, gehe eine Zeile nach unten oder breche ab, wenn du ganz fertig bist
           */
            i++;
    ...
    /**
     * Ueberschreibt die Ausgabefunktion Wir verwenden hier nur einen Zaehler n*n Stringerweiterungungen sind langsamer als StringBuffer
     */
    @Override
