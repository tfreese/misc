 ...
 */
public final class SudokuTransformations
{
    /**
     ...
     */
    public static void exchangeColsInOneBlockCol(final int blockCol, final int colOffset1, final int colOffset2)
    {
    ...
    /**
     * Quadranten kreuzweise tauschen. Funktioniert nur bei gerader Size. Setzt quadratische Blöcke {@link #blockRowCount} == {@link #blockColCount} voraus.
     */
    public static void exchangeQuadrantsCrosswise()
    {
        ...
        {
            throw new IllegalStateException("Die Methode exchangeQuadrantsCrosswise setzt quardratische Blöcke, blockRowCount == blockColCount, voraus");
        }

        // werfen Exception bei ungerader Size
        if ((size % 2) != 0)
        {
            throw new IllegalStateException("Aufruf exchangeQuadrantsCrosswise nur bei gerader size möglich");
        }
        ...
        for (int rowOffset = 0; rowOffset < halfSize; rowOffset++)
        {
            for (int colOffset = 0; colOffset < halfSize; colOffset++)
            {
                ...
                final int quadrantRightBottomCellValue = matrix[rowOffset + halfSize][colOffset + halfSize];
     ...
     */
    public static void exchangeRowsInOneBlockRow(final int blockRow, final int rowOffset1, final int rowOffset2)
    {
    ...
    /**
     * Sudoku diagonal spiegeln von links oben nach rechts unten. Setzt quadratische Blöcke {@link #blockRowCount} == {@link #blockColCount} voraus.
     */
    ...
    /**
     * Sudoku diagonal spiegeln von rechts oben nach links unten. Setzt quadratische Blöcke {@link #blockRowCount} == {@link #blockColCount} voraus.
     */
    ...
    public static void mirroringHorizontal()
    {
        ...
        /*
         * durch das Abrunden wird erreicht, dass bei ungerader size die genau in Mitte sitzende Zeile nicht verändert wird.
         */
    ...
    public static void mirroringVertikal()
    {
        ...
        /*
         * durch das Abrunden wird erreicht, dass bei ungerader size die genau in Mitte sitzende Spalte nicht verändert wird.
         */
        final int halfSize = (int) Math.floor(size / 2);
    ...
    /**
     * Sudoku um 2 Quadranten ( 90 Grad Winkel ) rotieren. Es gibt kein rotateRight und rotateLeft, weil beim Rotieren um zwei Quadranten immer das gleiche
     * rauskommt. Funktioniert nur bei gerader Size. Setzt quadratische Blöcke {@link #blockRowCount} == {@link #blockColCount} voraus.
     */
    public static void rotate()
    {
        ...
        if (blockRowCount != blockColCount)
        {
            throw new IllegalStateException("Die Methode rotate setzt quardratische Blöcke, blockRowCount == blockColCount, voraus");
        }
    ...
    /**
     * Erstellt ein neues {@link SudokuTransformations} Object.
     */
    private SudokuTransformations()
    {
        super();
    }
}
