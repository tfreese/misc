 ...
 */
public final class HazelcastJavaConfigNode1
{
    /**
    ...
    public static void main(final String[] args) throws Exception
    {
        ...
        ForkJoinPool.commonPool().execute(() -> {
            while (true)
            {
                ...
                System.out.printf("HazelcastJavaConfigNode1: %s: cache value = %s%n", Thread.currentThread().getName(), value);
    ...
    /**
     * Erstellt ein neues {@link HazelcastJavaConfigNode1} Object.
     */
    private HazelcastJavaConfigNode1()
    {
        super();
    }
}
