 ...
 */
// @Component
public class SensorScheduler implements ApplicationContextAware
{
    /**
     *
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(SensorScheduler.class);
    ...
    */
    ...
    /**
     * Erzeugt eine neue Instanz von {@link SensorScheduler}.
     */
