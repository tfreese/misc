...
public class SimpleBufferAllocator implements IoBufferAllocator
{
    ...
    private class SimpleBuffer extends AbstractIoBuffer
    {
        ...
        /**
         * @see de.freese.littlemina.core.buffer.AbstractIoBuffer#array()
         */
        @Override
        public byte[] array()
        {
        ...
        /**
         * @see de.freese.littlemina.core.buffer.AbstractIoBuffer#arrayOffset()
         */
        @Override
        ...
        /**
         * @see de.freese.littlemina.core.buffer.AbstractIoBuffer#asReadOnlyBuffer()
         */
        @Override
        public AbstractIoBuffer asReadOnlyBuffer()
        {
            return new SimpleBuffer(this.byteBuffer.asReadOnlyBuffer());
        }

        /**
         * @see de.freese.littlemina.core.buffer.AbstractIoBuffer#getByteBuffer()
         */
        @Override
        ...
        /**
         * @see de.freese.littlemina.core.buffer.AbstractIoBuffer#hasArray()
         */
        @Override
     ...
     */
    @Override
    public AbstractIoBuffer allocate(final int capacity, final boolean direct)
    {
     ...
     */
    @Override
    public AbstractIoBuffer wrap(final ByteBuffer nioBuffer)
    {
