...
/**
 * Allocates {@link AbstractIoBuffer}s and manages them.<br>
...
public interface IoBufferAllocator
{
     ...
     */
    public AbstractIoBuffer allocate(int capacity, boolean direct);
     ...
     *
     * @param nioBuffer {@link ByteBuffer}
     * @return {@link AbstractIoBuffer}
     */
    public AbstractIoBuffer wrap(ByteBuffer nioBuffer);
}
