...
/*
 * DragColorTextFieldDemo.java is a 1.4 example that requires the following files:
 * ColorTransferHandler.java ColorAndTextTransferHandler.java
 */
...
/**
 * Example code that shows a text component that both accepts dnd.color (by changing its foreground)
 * and also exports simple text.
 */
