...
/*
 * Class that manages area where the contents of files are displayed. When no files are present,
 * there is a simple JTextArea instructing users to drop a file. As soon as a file is dropped, a
 * JTabbedPane is placed into the window and each file is displayed under its own tab. When all the
 * files are removed, the JTabbedPane is removed from the window and the simple JTextArea is again
 * displayed.
 */
/**
